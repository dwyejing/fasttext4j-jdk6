...
import jdk.compatible.java.nio.file.OpenOption;
import jdk.compatible.java.nio.file.Path;
import jdk.compatible.java.nio.file.StandardOpenOption;
...
public class MMapFile {
  ...
  public ResourceOutput createOutput(int bufferSize, OpenOption... options) throws IOException {
    return new OutputStreamResourceOutput(path.toString(), new FilterOutputStream(new FileOutputStream(path.toFile())), bufferSize);
  }
